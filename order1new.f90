...
!***************************************m_e*****************************************
     m_e = (/0.0,0.0/)
     do i=0,Ns-1,4
           m_e(0) = m_e(0) -2.0*config(i,0) + config(i,1)+ config(i,2)  -2.0*config(i,0) + config(i,1)+ config(i,2) &
                        -2.0*config(i+2,0) - config(i+2,1)- config(i+2,2)  -2.0*config(i+2,0) - config(i+2,1)- config(i+2,2) &
                        +2.0*config(i+3,0) + config(i+3,1)- config(i+3,2)  +2.0*config(i+3,0) + config(i+3,1)- config(i+3,2) &
                        +2.0*config(i+1,0) - config(i+1,1)+ config(i+1,2)  +2.0*config(i+1,0) - config(i+1,1)+ config(i+1,2)
                      
           m_e(1) = m_e(1) -config(i,1) + config(i,2)+ config(i+2,1)-config(i+2,2)  -config(i,1) + config(i,2)+ config(i+2,1)-config(i+2,2) &
                         -config(i+3,1)- config(i+3,2) +config(i+1,1)+config(i+1,2) -config(i+3,1)- config(i+3,2) +config(i+1,1)+config(i+1,2) 
     end do
