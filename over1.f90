Subroutine overrelaxation(config,coordinates,matrix,neigh,Jij_matrix,L,Ns,iT)
...
double precision u,v,cost,v1,v2,x,E1,M1,E2,M2,R,phi,Pi,uu
...
Pi = 3.1415927 
     ...
     do j=0,Ns-1
          ...
          config(n,:) = s                                !modifiedconfiguration
     end do
